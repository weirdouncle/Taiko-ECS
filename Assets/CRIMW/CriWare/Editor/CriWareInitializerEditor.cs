...
public class CriWareInitializerEditor : UnityEditor.Editor
{
	...
	/* @cond excludele */
				...
				if (showAtomLINUXConfig) {
					...
					GenToggleField("Enable Atom Sound Disabled Mode", "", ref initializer.atomConfig.enableAtomSoundDisabledModeLinux);
					EditorGUI.indentLevel -= 1;
				}
	/* @endcond */
	...
	/* @cond excludele */
				...
				if (showAtomPs4Config) {
					GenIntField("Mp3 Voices", "", ref initializer.atomConfig.ps4Mp3StreamingVoices, 0, 1024);
				...
				if (showAtomPs5Config) {
					GenIntField("Mp3 Voices", "", ref initializer.atomConfig.ps5Mp3StreamingVoices, 0, 1024);
