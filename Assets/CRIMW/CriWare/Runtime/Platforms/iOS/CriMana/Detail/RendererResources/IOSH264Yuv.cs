...
namespace CriMana.Detail
{
	...
	public class RendererResourceIOSH264Yuv : RendererResource
	{
		...
		public override void UpdateTextures()
		{
			...
			bool isTextureUpdated = CRIWARE98BCB8A4(playerId, numTextures, nativePtrs); // out textures
...
#region DLL Import
		...
		private static extern bool CRIWARE88ED0C7C(int player_id);
#else
		private static bool CRIWARE88ED0C7C(int player_id) { return false; }
#endif
#endregion
	}
}
