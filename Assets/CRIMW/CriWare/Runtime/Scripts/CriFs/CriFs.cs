...
public class CriFsBinder : CriDisposable
{
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWARE2667177F(uint id);
	...
	private static int CRIWARE2667177F(uint id) { return 0; }
	#endif
...
public static class CriFsUtility
{
	...
	{
		/* User-Agent文字列を指定 */
		CRIWARE84BEC349(userAgentString);
	}
	...
	{
		/* プロキシ設定 */
		CRIWAREFCD2B03C(proxyPath, proxyPort);
	}
	...
	{
		CRIWARE5DD9478F(filter);
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE84BEC349(string userAgentString);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREFCD2B03C(string proxyPath, UInt16 proxyPort);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE5DD9478F(string filter);
	#else
	private static bool CRIWARE84BEC349(string userAgentString) { return true; }
	private static bool CRIWAREFCD2B03C(string proxyPath, UInt16 proxyPort) { return true; }
	private static bool CRIWARE5DD9478F(string filter) {return true; }
	#endif
	#endregion
}
...
public static class CriFsPlugin
{
	...
	public static void InitializeLibrary()
	{
		...
		/* ライブラリの初期化 */
		CriFsPlugin.CRIWARE465A9010();

#if !UNITY_EDITOR && UNITY_OPENHARMONY
		int harmony_context = 0;
		OpenHarmonyJSObject openHarmonyJSObject = new OpenHarmonyJSObject("CriTypeScriptClasses");
		harmony_context = openHarmonyJSObject.Call<int>("InitResourceManager");
#endif
	}
	...
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREF751143F(
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE465A9010();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE3EE8DF95();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE69791A6B();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE16F60B97();
	...
	private static void CRIWAREF751143F(
		int num_loaders, int num_binders, int num_installers, int max_path, bool minimize_file_descriptor_usage, bool enable_crc_check) { }
	private static void CRIWARE465A9010() { _dummyInitialized = true; }
	public static bool CRIWARE3EE8DF95() { return _dummyInitialized; }
	private static void CRIWARE69791A6B() { _dummyInitialized = false; }
	public static uint CRIWARE16F60B97() { return 0u; }
