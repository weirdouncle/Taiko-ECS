...
{
	/* スクリプトバージョン */
	private const string scriptVersionString = "2.43.46";
	...
	public static string streamingAssetsPath
	{
		get {
			...
			else if (Application.platform == RuntimePlatform.OpenHarmony) {
				return "Data/StreamingAssets";
			}
#elif UNITY_SWITCH
	...
	{
		return CriFsPlugin.CRIWARE16F60B97();
	}
	...
	{
		return CriAtomPlugin.CRIWARE7BA6D323();
	}
	...
	public static uint GetManaMemoryUsage()
	{
        ...
        return 0;
#else
		return CriManaPlugin.CRIWAREC729E61C();
#endif
	}
	...
	public static extern int CRIWARE0124771C();

	[DllImport(pluginName, CallingConvention = pluginCallingConvention)]
	public static extern void criWareUnity_SetRenderingEventOffsetForMana(int offset);
	#else
	public static int CRIWARE0124771C() { return GetRequiredBinaryVersionNumber(); }
