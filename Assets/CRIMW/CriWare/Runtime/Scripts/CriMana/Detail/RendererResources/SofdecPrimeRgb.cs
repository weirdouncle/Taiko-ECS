...
namespace CriMana.Detail
{
	...
	#error unsupported platform
		...
		{
			// Note: This renderer use a deprecated API: CRIWAREF9209937.
			// Todo: use CRIWARE98BCB8A4 with a c++ rendereDecoder class if needed.
			bool isFrameUpdated = CRIWAREF9209937(
				playerId,
		...
		private static extern bool CRIWAREF9209937(
			int player_id,
