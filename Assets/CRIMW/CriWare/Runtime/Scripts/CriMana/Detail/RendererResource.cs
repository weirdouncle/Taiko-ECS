...
namespace CriMana.Detail
{
	public abstract class RendererResource : System.IDisposable
	{
		...
		{
			return CRIWARE09BE03AE(playerId);
		}
		...
		protected static extern bool CRIWAREBF11A5D7(
			int player_id,
			int num_textures,
		...
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		protected static extern bool CRIWARE98BCB8A4(
			int player_id,
			int num_textures,
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWAREEF8C5366(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWARE3BB32612(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern sbyte CRIWARE09BE03AE(
            int player_id
        );
		#else
		protected static bool CRIWAREBF11A5D7(
			int player_id,
			int num_textures,
			System.IntPtr[] tex_ptrs,
			[In, Out] FrameInfo frame_info,
		...
		protected static bool CRIWARE98BCB8A4(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREEF8C5366(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWARE3BB32612(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

        protected static sbyte CRIWARE09BE03AE(
            int player_id
        ) { return 0; }
		#endif
		#endregion
