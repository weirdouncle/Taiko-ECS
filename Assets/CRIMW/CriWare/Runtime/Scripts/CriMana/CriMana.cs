...
namespace CriMana
{
	...
	public static class Settings
	{
		...
		{
			CriManaPlugin.CRIWAREEE8E1F80(enabled);
		}
...
public class CriManaPlugin
{
	...
	/**
	 * <summary>Event just before the Mana library initialization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called just before the Mana library is initialized. <br/>
	 * The contents will not be cleared.</para>
	 * </remarks>
	 */
	public static event System.Action OnBeforeInitialize = null;

	/**
	 * <summary>Event immediately after the Mana library initialization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called immediately after the Mana library is initialized. <br/>
	 * The contents will be cleared.</para>
	 * </remarks>
	 */
	public static event System.Action OnInitialized = null;

	/**
	 * <summary>Event just before the Mana Library finalization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called just before the Mana library is closed. <br/>
	 * The contents will not be cleared.</para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>Event immediately after the Mana Library finalization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called immediately after the Mana library is initialized. <br/>
	 * The contents will be cleared.</para>
	 * </remarks>
	...
	public static void SetConfigParameters(bool graphicsMultiThreaded, int num_decoders, int max_num_of_entries)
	{
		...
		CriManaPlugin.CRIWAREB4DB183E((int)graphicsApi, enabledMultithreadedRendering, num_decoders, max_num_of_entries);
	...
	*/
	...
	public static void SetConfigAdditonalParameters_VITA(bool use_h264_playback, int width, int height)
	{
		...
		CriManaPlugin.CRIWARE21151A08(use_h264_playback, (UInt32)width, (UInt32)height);
#endif
	}
	...
	public static void SetConfigAdditonalParameters_PC(bool use_h264_playback)
	{
		...
		CriManaPlugin.CRIWARE22490A87(use_h264_playback);
#endif
	}
	...
	public static void SetConfigAdditonalParameters_WEBGL(string webworkerPath, uint heapSize)
	{
		...
		CriManaPlugin.CRIWARE4BBCB2A6(webworkerPath,heapSize);
#endif
	}
...
#if UNITY_EDITOR
		/* Editor向けVP9初期化、ランタイムはプラグイン側から登録 */
		SetupVp9();		
#endif
		/* ライブラリの初期化 */
		OnBeforeInitialize?.Invoke();
		CriManaPlugin.CRIWAREB59D2482();
	...
	*/
	...
	{
		CriManaPlugin.CRIWAREB26B8FE7();
	}

	public static void Unlock()
	{
		CriManaPlugin.CRIWAREE16AC202();
	}

	public static UInt32 GetPrimeBufferAlignmentSize()
	{
		return CRIWARE69FBC135();
	}
	...
	public static bool AnalyzeMovieHeader(IntPtr data, out CriMana.MovieInfo movieInfo)
	{
		...
		return CriManaPlugin.CRIWAREF717A195(data, movieInfo);
	}

#region DLL Import
#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREB4DB183E(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREB59D2482();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE9F76DF16();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREAB5F01A1();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREEE8E1F80(bool flag);
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWAREF717A195(IntPtr movie_header_ptr, [Out] CriMana.MovieInfo mvinf);

#if !UNITY_EDITOR && UNITY_WEBGL
#else
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWAREC729E61C();
#endif
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE22490A87(bool enable);
#endif
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE21151A08(bool use_h264_playback, UInt32 width, UInt32 height);
#elif !UNITY_EDITOR && UNITY_WEBGL
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE4BBCB2A6(string webworkerPath, uint heapSize);
#endif
#else
	private static bool _dummyInitialized = false;
	private static void CRIWAREB4DB183E(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries) { }
	private static void CRIWAREB59D2482() { _dummyInitialized = true; }
	public static bool CRIWARE9F76DF16() { return _dummyInitialized; }
	private static void CRIWAREAB5F01A1() { _dummyInitialized = false; }
	public static void CRIWAREEE8E1F80(bool flag) { }
	public static void CRIWAREB26B8FE7() { }
	public static void CRIWAREE16AC202() { }
	private static UInt32 CRIWARE69FBC135() { return 32u; }
	public static void criMana_UseStreamerManager(bool flag) { }
	public static bool criMana_IsStreamerManagerUsed() { return false; }
	public static bool CRIWAREF717A195(IntPtr movie_header_ptr, [Out] CriMana.MovieInfo mvinf){ return true; }
#if !UNITY_EDITOR && UNITY_WEBGL
#else
	public static uint CRIWAREC729E61C() { return 0u; }
#endif
#if UNITY_EDITOR_WIN || (!UNITY_EDITOR && UNITY_STANDALONE_WIN)
	...
	public static void CRIWARE22490A87(bool enable) { }
#endif
#if !UNITY_EDITOR && UNITY_ANDROID
...
#endif
#elif !UNITY_EDITOR && UNITY_PSP2
	public static void CRIWARE21151A08(bool use_h264_playback, UInt32 width, UInt32 height) { }
#elif !UNITY_EDITOR && UNITY_WEBGL
	public static void CRIWARE4BBCB2A6(string webworkerPath, uint heapSize) { }
#endif
#endif
#endregion
}
