...
public class CriAtomConfig {
	...
	/** [PS5] mp3 voice pool creation parameters */
	public int ps5Mp3StreamingVoices = 0;
	...
	/** [PS5] mp3 voice pool creation parameters */
	public int ps4Mp3StreamingVoices = 0;
