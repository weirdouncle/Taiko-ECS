...
public static class CriAtomPlugin
{
	...
	/**
	 * <summary>Event just before the Atom library initialization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called just before the Atom library is initialized. <br/>
	 * Once called, the content will not be cleared.</para>
	 * </remarks>
	 */
	public static event System.Action OnBeforeInitialize = null;

	/**
	 * <summary>Event immediately after the Atom library initialization</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called just before the Atom library is initialized. <br/>
	 * Once called, the content will be cleared.</para>
	 * </remarks>
	 */
	public static event System.Action OnInitialized = null;

	/**
	 * <summary>Event just before the end of the Atom library</summary>
	 * <remarks>
	 * <para header='Description'>This is a callback event that is called just before the Atom library is closed. <br/>
	 * Once called, the content will not be cleared.</para>
	 * </remarks>
	 */
...
#endif
	/* @endcond */
		CRIWAREAADCF40E(max_virtual_voices,
		...
		int communication_buffer_size, int playback_position_update_interval)
	{
		...
		CRIWAREEAF72074((uint)max_preview_objects,
	...
	{
		CRIWAREDC0851E6(enable_user_pcm_output);
	...
	{
		CRIWARE754CB4C0(enable_sonicsync, buffering_time_ios, override_ipod_music_ios, enable_os_notification_handling);
	}
															 ...
															 int stream_type)
	{
		...
		CRIWARE5290742E(enable_sonicsync,
		...
		if (use_fast_mixer == true) {
			...
			using (AndroidJavaObject activity = jc.GetStatic<AndroidJavaObject>("currentActivity")) {
				...
				CRIWARE512EA3ED(android_context);
			}
		}
		CRIWARE1043A2C2(use_aaudio);
#endif
	}
	...
	public static void SetConfigAdditionalParameters_VITA(int num_atrac9_memory_voices, int num_atrac9_streaming_voices, int num_mana_decoders)
	{
		...
		CRIWARE00B9FEBE(num_atrac9_memory_voices, num_atrac9_streaming_voices, num_mana_decoders);
		#endif
	}

	public static void SetConfigAdditionalParameters_PS4(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
														 bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices, int num_mp4_streaming_voices)
	{
		#if !UNITY_EDITOR && (UNITY_PS4 || UNITY_PS5)
		CRIWARED159CB83(num_atrac9_memory_voices, num_atrac9_streaming_voices,
														use_audio3d, num_audio3d_memory_voices, num_audio3d_streaming_voices,  num_mp4_streaming_voices);
		#endif
	}
	...
	public static void SetConfigAdditionalParameters_PS5(int max_channel_ports, int max_object_ports, int num_mp4_streaming_voices)
	{
		...
		CRIWAREF54C2B8E(max_channel_ports, max_object_ports, num_mp4_streaming_voices);
		#endif
	}
	...
	public static void SetConfigAdditionalParameters_SWITCH(bool enable_sonicsync, int num_opus_memory_voices,
		...
		CRIWAREF814D257(enable_sonicsync, num_opus_memory_voices, num_opus_streaming_voices, init_socket);
		#endif
	}
	...
	{
		#if UNITY_WEBGL
		CRIWARE37978FE5(num_webaudio_voices);
		#endif
	}
	/* @endcond */
	...
	{
		CRIWAREE95F6783(sampling_rate_for_memory, sampling_rate_for_streaming);
	}
	...
	{
		return CRIWAREB21BA418();
	}

	public static bool IsInitializedForPcmOutput()
	{
	#if UNITY_EDITOR
		return CRIWAREA2D0A572();
	#else
		return false;
	#endif
	}
	...
	{
		ushort ret = CRIWARE2EBA9BD6(CRIATOMUNITY_PARAMETER_ID_LOOP_COUNT);
	...
	/**
	 * <summary>Get waveform data in the Cue</summary>
	 * <returns>Whether the acquisition succeeded</returns>
	 * <param name='acb'>ACB handle</param>
	 * <param name='cueName'>Cue name</param>
	 * <param name='decodeLpcmBuffer'>Array to store the data</param>
	 * <remarks>
	 * <para header='Description'>Get the waveform data in the specified Cue. <br/>
	 * If the Cue contains multiple waveforms, only the data for the first one will be returned. <br/>
	 * <br/>
	 * The data is returned as an interleaved array of length [number of samples * number of channels]. <br/>
	 * Please specify an array of sufficient length in <paramref name='decodeLpcmBuffer'/>.<code>
	...
	public static bool GetWaveSamples(CriAtomExAcb acb, string cueName, System.Int16[] decodeLpcmBuffer)
	{
		...
		var result = CRIWARE24040135(acb.nativeHandle, cueName, handle.AddrOfPinnedObject(), decodeLpcmBuffer.Length);
		handle.Free();
		return result;
#endif
	}
	...
	public static void DecryptAcb(IntPtr acb_hn, ulong key, ulong nonce)
	{
		...
		CRIWAREE061F765(acb_hn, CallbackFromNative, IntPtr.Zero);
		temporalStorage = 0;
	}
	/* @endcond */
	...
	#region DLL Import
#if !CRIWARE_ENABLE_HEADLESS_MODE && UNITY_STANDALONE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE24040135(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength);
#else
	private static bool CRIWARE24040135(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength) {return false;}
#endif
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREAADCF40E(int max_virtual_voices,
		int max_voice_limit_groups, int max_categories,
		System.Byte max_aisacs, System.Byte max_bus_sends,
		int max_sequence_events_per_frame, int max_beatsync_callbacks_per_frame,
		int max_cuelink_callbacks_per_frame,
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREEAF72074(uint max_preivew_objects,
		uint communication_buffer_size, int playback_position_update_interval);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREDC0851E6(bool enable_user_pcm_out_mode);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARED4FAE8F1(long buffering_time_pc, bool use_microsoft_spatial_sound);

	/* @cond excludele */
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREEB554F2D(int output, int pulse_latency_usec);
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE754CB4C0(bool enable_sonicsync, uint buffering_time_ios, bool override_ipod_music_ios, bool enable_os_notification_handling);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE5290742E(bool enable_sonicsync, 
																				  int num_low_delay_memory_voices, int num_low_delay_streaming_voices,
																				  int sound_buffering_time,        int sound_start_buffering_time,
	...
	#if !UNITY_EDITOR && UNITY_ANDROID
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE512EA3ED(IntPtr android_context);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE1043A2C2(bool flag);
	#endif

	/* @cond excludele */
	#if !UNITY_EDITOR && UNITY_PSP2
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE00B9FEBE(int num_atrac9_memory_voices, int num_atrac9_streaming_voices, int num_mana_decoders);
	#endif

	#if !UNITY_EDITOR && (UNITY_PS4 || UNITY_PS5)
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARED159CB83(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																			  bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices, int num_mp4_streaming_voices);
	#endif

	#if !UNITY_EDITOR && UNITY_PS5
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREF54C2B8E(int max_channel_ports, int max_object_ports, int num_mp4_streaming_voices);
	#endif

	#if !UNITY_EDITOR && UNITY_SWITCH
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREF814D257(bool enable_sonicsync, int num_opus_memory_voices,
																				 int num_opus_streaming_voices, bool init_socket);
	#endif

	#if UNITY_WEBGL
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE37978FE5(int num_webaudio_voices);
	#endif
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE38EEE1D5();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE75DF1E42();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE2678640D();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE34097C3E(bool pause);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE7BA6D323();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE13BBB5DA(int code);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE4E9C48FD(IntPtr cbfunc, string separator_string);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE582CCB33(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE36DA2D88();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREBC091183(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREE2D1EA3F();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE69B2B927(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE2B87A431();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREE95F6783(int sampling_rate_for_memory, int sampling_rate_for_streaming);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE6C2CD31F();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE215E2A72();

	/* @cond notpublic */
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREE061F765(IntPtr acb_hn, CallbackFromNativeDelegate func, IntPtr obj);
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern ushort CRIWARE2EBA9BD6(int id);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREA2D0A572();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREDFF62DCB();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREB21BA418();

	#else
	private static void CRIWAREAADCF40E(int max_virtual_voices,
		int max_voice_limit_groups, int max_categories,
		System.Byte max_aisacs, System.Byte max_bus_sends,
		int max_sequence_events_per_frame, int max_beatsync_callbacks_per_frame,
		int max_cuelink_callbacks_per_frame,
		...
		CriAtomEx.SoundRendererType sound_renderer_type, bool enable_sonicsync_for_common,
		bool enable_atom_sound_disabled_mode) { }
	private static void CRIWAREEAF72074(uint max_preivew_objects,
		uint communication_buffer_size, int playback_position_update_interval) { }
	private static void CRIWAREDC0851E6(bool enable_user_pcm_out_mode) { }
	private static void CRIWARED4FAE8F1(long buffering_time_pc, bool use_microsoft_spatial_sound) { }
	/* @cond excludele */
	private static void CRIWAREEB554F2D(int output, int pulse_latency_usec) { }
	/* @endcond */
	private static void CRIWARE754CB4C0(bool enable_sonicsync, uint buffering_time_ios, bool override_ipod_music_ios, bool enable_os_notification_handling) { }
	private static void CRIWARE5290742E(bool enable_sonicsync, 
																		   int num_low_delay_memory_voices, int num_low_delay_streaming_voices,
																		   int sound_buffering_time,        int sound_start_buffering_time,
																		   bool apply_hw_property,          int stream_type) { }
	#if !UNITY_EDITOR && UNITY_ANDROID
	private static void CRIWARE512EA3ED(IntPtr android_context) { }
	private static void CRIWARE1043A2C2(bool flag) { }
	#endif

	/* @cond excludele */
	#if !UNITY_EDITOR && UNITY_PSP2
	private static void CRIWARE00B9FEBE(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																		int num_mana_decoders) { }
	#endif
	#if !UNITY_EDITOR && (UNITY_PS4 || UNITY_PS5)
	private static void CRIWARED159CB83(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																		bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices, int num_mp4_streaming_voices) { }
	#endif
	#if !UNITY_EDITOR && UNITY_PS5
	private static void CRIWAREF54C2B8E(int max_channel_ports, int max_object_ports, int num_mp4_streaming_voices) { }
	#endif
	#if !UNITY_EDITOR && UNITY_SWITCH
	private static void CRIWAREF814D257(bool enable_sonicsync, int num_opus_memory_voices,
																		  int num_opus_streaming_voices, bool init_socket) { }
	#endif
	#if UNITY_WEBGL
	private static void CRIWARE37978FE5(int num_webaudio_voices) { }
	#endif
	/* @endcond */
	private static bool _dummyInitialized = false;
	private static void CRIWARE38EEE1D5() { _dummyInitialized = true; }
	public static bool CRIWARE75DF1E42() { return _dummyInitialized; }
	private static void CRIWARE2678640D() { _dummyInitialized = false; }
	private static void CRIWARE34097C3E(bool pause) { }
	public static uint CRIWARE7BA6D323() { return 0; }
	public static void CRIWARE13BBB5DA(int code) { }
	public static void CRIWARE4E9C48FD(IntPtr cbfunc, string separator_string) { }
	public static void CRIWARE582CCB33(IntPtr cbfunc) { }
	public static void CRIWARE36DA2D88() { }
	public static void CRIWAREBC091183(IntPtr cbfunc) { }
	public static void CRIWAREE2D1EA3F() { }
	public static void CRIWARE69B2B927(IntPtr cbfunc) { }
	public static void CRIWARE2B87A431() { }
	private static void CRIWAREE95F6783(int sampling_rate_for_memory, int sampling_rate_for_streaming) { }
	public static void CRIWARE6C2CD31F() { }
	public static void CRIWARE215E2A72() { }
	/* @cond notpublic */
	public static void CRIWAREE061F765(IntPtr acb_hn, CallbackFromNativeDelegate func, IntPtr obj) { }
	/* @endcond */
	public static ushort CRIWARE2EBA9BD6(int id) { return 0; }
	private static bool CRIWAREA2D0A572() { return false; }
	private static int CRIWAREDFF62DCB() { return 0; }
	private static int CRIWAREB21BA418() { return 0; }
	#endif
	#endregion
	...
	*/
	...
	void OnDestroy()
	{
		...
		if (beatsyncUserCbFunc != null) {
			...
			CriAtomPlugin.CRIWAREBC091183(IntPtr.Zero);
		}
	...
	public static void SetEventCallback(CriAtomExSequencer.EventCbFunc func, string separator)
	{
		...
		CriAtomPlugin.CRIWARE4E9C48FD(ptr, separator);
	}
	...
	private static void RegisterEventCallbackChain(CriAtomExSequencer.EventCallback func)
	{
		...
		if (eventUserCallback == null) {
			...
			ptr = Marshal.GetFunctionPointerForDelegate(delegateObject);
			CriAtomPlugin.CRIWARE582CCB33(ptr);
		}
	...
	private static void UnregisterEventCallbackChain(CriAtomExSequencer.EventCallback func)
	{
		eventUserCallback -= func;
		if (eventUserCallback == null) {
			CriAtomPlugin.CRIWARE582CCB33(IntPtr.Zero);
		}
	}
	...
	private static void RegisterBeatSyncCallbackChain(CriAtomExBeatSync.CbFunc func)
	{
		if (beatsyncUserCbFunc == null) {
			...
			CriAtomPlugin.CRIWAREBC091183(ptr);
		}
	...
	private static void RegisterCueLinkCallbackChain(CriAtomEx.CueLinkCbFunc func)
	{
		if (cueLinkUserCbFunc == null) {
			...
			var ptr = Marshal.GetFunctionPointerForDelegate(delegateObject);
			CriAtomPlugin.CRIWARE69B2B927(ptr);
		}
	...
	private static void UnregisterCueLinkCallbackChain(CriAtomEx.CueLinkCbFunc func)
	{
		cueLinkUserCbFunc -= func;
		if (cueLinkUserCbFunc == null) {
			CriAtomPlugin.CRIWARE69B2B927(IntPtr.Zero);
		}
	}
